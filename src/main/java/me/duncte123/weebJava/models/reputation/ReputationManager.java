...
public interface ReputationManager {
     ...
     *
     * @param sourceUserId The user that gives the reputation
     ...
     *
     * @param userId The user to increase the reputation for
     ...
     *
     * @param userId The user to decrease the reputation for
     ...
     *
     * @param settings The {@link ReputationSettings settings} that you want to apply
